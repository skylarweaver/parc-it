 ...
 * @returns {KeyCheckResponse}
 */
export function validate_keys(public_keys, double_blind_key) {
    const ptr0 = passStringToWasm0(public_keys, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(double_blind_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.validate_keys(ptr0, len0, ptr1, len1);
    return KeyCheckResponse.__wrap(ret);
}

const CircuitFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_circuit_free(ptr >>> 0, 1));
...
export class Circuit {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        CircuitFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_circuit_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.circuit_new();
        this.__wbg_ptr = ret >>> 0;
        CircuitFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    generate_signature(message, public_keys, double_blind_key) {
        ...
        try {
            ...
            const ret = wasm.circuit_generate_signature(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var ptr4 = ret[0];
            var len4 = ret[1];
            if (ret[3]) {
                ptr4 = 0; len4 = 0;
    ...
    read_signature(message, signature) {
        ...
        try {
            ...
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.circuit_read_signature(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
...
const KeyCheckResponseFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_keycheckresponse_free(ptr >>> 0, 1));

export class KeyCheckResponse {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(KeyCheckResponse.prototype);
        obj.__wbg_ptr = ptr;
        KeyCheckResponseFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        KeyCheckResponseFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_keycheckresponse_free(ptr, 0);
    }
    /**
     * @returns {Uint8Array}
     */
    get public_keys_valid() {
        const ret = wasm.__wbg_get_keycheckresponse_public_keys_valid(this.__wbg_ptr);
     ...
     */
    set public_keys_valid(arg0) {
        const ptr0 = passArray8ToWasm0(arg0, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_keycheckresponse_public_keys_valid(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {boolean}
     */
    get double_blind_key_valid() {
        const ret = wasm.__wbg_get_keycheckresponse_double_blind_key_valid(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {boolean} arg0
     */
    set double_blind_key_valid(arg0) {
        wasm.__wbg_set_keycheckresponse_double_blind_key_valid(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number | undefined}
     */
    get user_public_key_index() {
        const ret = wasm.__wbg_get_keycheckresponse_user_public_key_index(this.__wbg_ptr);
        return ret === 0x100000001 ? undefined : ret;
    }
    /**
     * @param {number | null} [arg0]
     */
    set user_public_key_index(arg0) {
        wasm.__wbg_set_keycheckresponse_user_public_key_index(this.__wbg_ptr, isLikeNone(arg0) ? 0x100000001 : (arg0) >>> 0);
    }
}
